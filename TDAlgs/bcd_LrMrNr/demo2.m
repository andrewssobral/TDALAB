...
% The function bcdLrMrNr_alsls has 2 kinds of optional input arguments to deal with initialization:
...
[A_init,B_init,C_init,D_init,phi,itInit]=bcdLrMrNr_alsls(X,L_vec,M_vec,N_vec,[],[],[],MaxItInit,[],[],Ninit);
% Then go on with the best starting point
[A_est,B_est,C_est,D_init,phi,it1]=bcdLrMrNr_alsls(X,L_vec,M_vec,N_vec,[],[],[],[],[],[],[],A_init,B_init,C_init);
