% demo 1 to test bcdLL1_alsls algorithm.
% The purpose of this demo is to observe the different convergence curves for 
% different initializations.
% The starting point is generated with bcdLL1_init.m function. 
% The first starting point is generated by generalized EVD and the others are random.
...
for ninit=1:Ninit
    ...
    disp('*********************************************************************')
    tic
    [A_est,B_est,C_est,phi,it1,it2,phi_vec]=bcdLL1_alsls(X,R,L,lsearch,comp,Tol1,MaxIt1,Tol2,MaxIt2,Ninit,A_init,B_init,C_init);
    time=toc;
    ...
    loglog(phi_vec,'r','LineWidth',2);hold on;
    xlabel('Iterations')
    ylabel('phi')
